...
function build_extension {
    ...
    if [ -d "$EXTENSION/system_config" ]
    then
        for f in $EXTENSION/system_config/*
        do
            install_system_config $f
        done
    fi
    ...
    if [ -d "$EXTENSION/distro_configs" ]
    then
        for f in $EXTENSION/distro_configs/*
        do
            install_distro_config $f
        done
    fi
