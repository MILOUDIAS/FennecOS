...
export PKG_BC=https://github.com/gavinhoward/bc/releases/download/6.7.6/bc-6.7.6.tar.xz
...
# NEW
export PKG_FLITCORE=https://pypi.org/packages/source/f/flit-core/flit_core-3.9.0.tar.gz
export PKG_GAWK=https://ftp.gnu.org/gnu/gawk/gawk-5.3.0.tar.xz
...
export PKG_IANAETC=https://github.com/Mic92/iana-etc/releases/download/20240806/iana-etc-20240806.tar.gz
...
export PKG_IPROUTE2=https://www.kernel.org/pub/linux/utils/net/iproute2/iproute2-6.10.0.tar.xz
# NEW
export PKG_JINJA=https://pypi.org/packages/source/J/Jinja2/jinja2-3.1.4.tar.gz
...
export PKG_LINUX=https://www.kernel.org/pub/linux/kernel/v6.x/linux-6.10.5.tar.xz
...
export PKG_MANDB=https://download.savannah.gnu.org/releases/man-db/man-db-2.12.1.tar.xz
export PKG_MANPAGES=https://www.kernel.org/pub/linux/docs/man-pages/man-pages-6.9.1.tar.xz
export PKG_MESON=https://github.com/mesonbuild/meson/releases/download/1.5.1/meson-1.5.1.tar.gz
# NEW
export PKG_MARKUPSAFE=https://pypi.org/packages/source/M/MarkupSafe/MarkupSafe-2.1.5.tar.gz
...
export PKG_OPENSSL=https://www.openssl.org/source/openssl-3.3.1.tar.gz
export PKG_PATCH=https://ftp.gnu.org/gnu/patch/patch-2.7.6.tar.xz
export PKG_PERL=https://www.cpan.org/src/5.0/perl-5.38.2.tar.gz
...
export PKG_PYTHON=https://www.python.org/ftp/python/3.12.5/Python-3.12.5.tar.xz
export PKG_PYTHONDOCS=https://www.python.org/ftp/python/doc/3.12.5/python-3.12.5-docs-html.tar.bz2
...
export PKG_TCL=https://downloads.sourceforge.net/tcl/tcl8.6.14-src.tar.gz
