...
touch $ROOTFS/iso/mkinitramfs.conf
msg "generating livecd initramfs..."
run_chroot /iso/mkinitramfs -c /iso/mkinitramfs.conf -k $KERNELVER -i /iso/init -a /iso/liveiso -o /iso/initrd
rm $ROOTFS/iso/mkinitramfs $ROOTFS/iso/init $ROOTFS/iso/mkinitramfs.conf $ROOTFS/iso/liveiso.hook

cp $KERNELFILE work/_live/boot/vmlinuz
mv $ROOTFS/iso/initrd work/_live/boot/initrd
